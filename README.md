...
[![Go Reference](https://pkg.go.dev/badge/github.com/jabobon1/invest-api-go-sdk.svg)](https://pkg.go.dev/github.com/jabobon1/invest-api-go-sdk)

SDK предназначен для упрощения работы с API Инвестиций.

## Начало работы

    go get github.com/jabobon1/invest-api-go-sdk

### Где взять токен аутентификации?

В разделе инвестиций вашего  [личного кабинета tinkoff](https://www.tbank.ru/invest/) . Далее:

* Перейдите в [настройки](https://www.tbank.ru/invest/settings/)
...
Документацию непосредственно по INVEST API можно найти по [ссылке](https://developer.tbank.ru/invest/intro/intro).
...
и текущий остаток запросов соответсвенно. Подробнее про заголовки [тут](https://developer.tbank.ru/invest/intro/developer/protocols/grpc)
...
[Основной репозиторий с документацией](https://developer.tbank.ru/invest/intro/intro/) — в нем вы можете получить разверную информацию по API и новости о релизах.
